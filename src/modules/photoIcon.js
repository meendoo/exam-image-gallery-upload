...
export default function photoIcon({width, height, fill}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={height || "48"} width={width || "48"} viewBox="0 0 48 48" fill={fill || "currentColor"}>
